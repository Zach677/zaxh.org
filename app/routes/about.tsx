    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 pt-32">
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-8">
          <h1 className="text-h1 text-gray-900 dark:text-white mb-8">
            About Me
          </h1>
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            <div className="flex flex-col md:flex-row gap-8 mb-8">
              <div className="flex-1">
                <h2 className="text-h3 text-gray-900 dark:text-white mb-4">
                  Hello, I'm Zach
                </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-h4 text-gray-900 dark:text-white mb-4">
                  My Interests
                </h3>
                <ul className="list-disc list-inside text-body text-gray-600 dark:text-gray-300 space-y-2">
              ...
              <div>
                ...
                <div className="space-y-2 text-body text-gray-600 dark:text-gray-300">
